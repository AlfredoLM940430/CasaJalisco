...
import { onFindComprados, onUnconfirmTicket, onConfirmTicket, onFindApartados, onFindTicket, onFindUserId, onFindGanador, onGettingGanador, onReset, onClear } from "../store/admin/adminSlice";
...
export const useAdminStore = () => {
    ...
    const startGettingWinner = async() => {
        try {
            const data = await lottoApi.post('/admin/getwinner');
            dispatch(onGettingGanador(data.data));
            return data.data;
        } catch (error) {
            console.log(error);
            return error;
